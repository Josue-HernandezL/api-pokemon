...
const getPokemon = async (query) => {
  try {
    ...
    main.innerHTML = `
                        ...
                        <div class="pokemon__datos">
                            ...
                            <div class="pokemon__estadisticas">
                              <ul class="estadisticas__pokemon">
                                <li class="lis"><span>HP:</span>${stats[0].base_stat}</li>
                                <li class="lis"><span>Attack:</span>${stats[1].base_stat}</li>
                                <li class="lis"><span>Defense:</span>${stats[2].base_stat}</li>
                                ${templateMoves}
     ...
     document.querySelector(".error_btn").addEventListener("click",e=> location.reload());
  }
};
